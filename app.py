# app.py - VERSIÓN COMPLETA CON TU CÓDIGO ORIGINAL
...
with st.spinner("🔄 Procesando datos... Por favor espera"):
    try:
        ...
        with col1:
            st.markdown(f"""
            <div style="background: #fef9e7; border: 1px solid #f9e79f; padding: 12px 16px; border-radius: 10px;">
        ...
        with col2:
            st.markdown(f"""
            <div style="background: #eafaf1; border: 1px solid #a9dfbf; padding: 12px 16px; border-radius: 10px; color: #1a7a42;">
